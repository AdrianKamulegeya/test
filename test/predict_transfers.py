...
class Prediction:
    ...
    def plot_learning_curve(self, model, title, X, y, ylim=None,
        ...
        train_sizes, train_scores, test_scores = learning_curve(
            model, X, y, cv=cv, n_jobs=n_jobs, scoring='accuracy',  train_sizes=train_sizes)
...
def main():
    ...
    # prediction.plot_learning_curve(MLPClassifier(), 'Learning Curves (Multilayer Perceptron), K=2000',
